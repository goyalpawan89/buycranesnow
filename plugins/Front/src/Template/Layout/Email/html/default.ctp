...
<p style="margin:20px 0 20px; text-align: center; color:#7C7B7B;">
	<b><a href="http://nextcrane.com" style="color:#e8a60c; text-decoration:none;">www.nextcrane.com</a></b><br>
	<?= __d('front', 'KHOLN INVESTMENTS INC'); ?><br>
	<?= __d('front', '14303 Foxcroft Road'); ?><br>
	<?= __d('front', 'Raleigh NC 27614'); ?><br>
	<?= __d('front', 'Tel: (954) 769 00 39'); ?><br>
	<a href="mailto:commercial@nextcrane.com" style="color:#e8a60c; text-decoration:none;"><?= __d('front', 'Email: commercial@nextcrane.com'); ?></a><br>
</p>
