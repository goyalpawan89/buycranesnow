...
<?php foreach ($posts as $key => $post)   {
        ...
        $avalibleName = 'avalible_'.$avalible;
                            ...
                            if($authUser) { $btnAction = '#offer_popup'; } else {  $btnAction = '#login'; }
                              ...
                              <aside class="list-post_text_description">
                                ...
                                <div>
                                  ...
                                  <div class='list-post_text_ofert'>
                                      ...
                                      <?php if($post['crane_status'] == 0) {  echo $this->Html->link(__($extras[$btnAvalible]), $btnAction, ['class' => 'need_premium fancybox btn btn-link fondo1 fondoh3 color3 colorh0', 'data-offer' => $btnAvalible ]); } ?>
...
<!-- fancybox categorias -->
<div id="offer_popup" class="loginbox">
    <h1></h1>
    <aside class="offer_form_pop">Cargando...</aside>
</div>
