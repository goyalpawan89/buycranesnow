...
$(".select-thumbnail .checkbox-select").click(
    function(event) {
      ...
      $('.<?= $fileuploader_class; ?>').css('backgroundImage','url(' + fondo + ')'); // cambia el fondo de la imagen destacada (llamamos el div desde el controlador(el controlador recoge el div desde el elemento con las variables))
